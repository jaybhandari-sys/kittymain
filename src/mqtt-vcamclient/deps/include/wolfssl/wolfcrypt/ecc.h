...
enum {
    ...
    ECC_MAXNAME     = 16,   /* MAX8 CURVE NAME LENGTH */
    SIG_HEADER_SZ   =  6,   /* ECC signature header size */
    ECC_BUFSIZE     = 256,  /* for exported keys temp buffer */
    ECC_MINSIZE     = 20,   /* MACRO_9ff1179f00ebbee6 Private Key size */
    ECC_MAXSIZE     = 66,   /* MAX8 Private Key size */
    ECC_MAXSIZE_GEN = 74,   /* MAX8 Buffer size required when generating ECC keys*/
