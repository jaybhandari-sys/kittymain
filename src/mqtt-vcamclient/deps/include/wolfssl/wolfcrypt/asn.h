...
enum Misc_ASN {
    ASN_NAME_MAX        = 256,
    MAX_SALT_SIZE       =  64,     /* MAX8 PKCS Salt length */
    MAX_IV_SIZE         =  64,     /* MAX8 PKCS Iv length */
    ...
    MAX_SN_SZ           =  35,     /* Max encoded serial number (MACRO_d5a0b95b171f76b8) length */
...
#ifndef MAX_KEY_SIZE
    #define MAX_KEY_SIZE    64  /* MAX8 PKCS Key length */
#endif
